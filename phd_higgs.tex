...
Cette formule suppose que nous disposons d'un lot d'électrons parfaitement purs. Lorsque ça n'est pas le cas, il faut soustraire la fraction de bruit de fond aux c\oe fficients $ A $ et $ B $. La méthode mise en \oe uvre effectue un ajustement de la distribution de masse invariante des bosons $ Z $ avant et après application de la coupure de sélection $ C $. Le signal est décrit par le produit de convolution d'une distribution Breit et Wigner et d'une distribution Crystal Ball (voir annexe A). Le bruit de fond est décrit par une distribution exponentielle :
\begin{equation}
