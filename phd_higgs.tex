...
\begin{figure}[!p]
  ...
  \end{bigcenter}
  \caption{\label{allHiggs5}Limites d'exclusion à $ 95\% $ de niveau de confiance du boson de Higgs attendues et observées sur la section efficace du boson de Higgs du modèle standard par rapport à la section efficace totale du modèle standard en fonction de la masse du boson de Higgs.}
\end{figure}
