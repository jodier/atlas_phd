...
Dans ce chapitre, nous avons étudié les objets calorimétriques, électrons d'ionisation et photons de radiation, issus de muons cosmiques. Dans ce but, nous avons défini une sélection permettant de disposer d'une accéptance équivalente pour les données et pour la simulation Monte-Carlo. Nous avons ensuite réalisé la première analyse, avec des données réelles, des variables de forme de gerbes électromagnétiques. En dépit de la faible statistiques disponible, nous pouvons conclure que la simulation des variables de forme de gerbes électromagnétiques est réaliste. Finalement, nous avons observé l'effet de la projectivité ainsi que l'effet de l'amélioration de la simulation de la diaphonie entre les cellules des deux premiers compartiments.
