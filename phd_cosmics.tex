...
Au vu de la statistique disponible, il n'est pas possible de traiter séparément les parties inférieure $ \phi<0 $ et supérieure $ \phi>0 $ du détecteur Atlas. La figure \ref{cosmics_s2endcap} (b) montrent la distribution de la variable $ F_{side} $. L'accord entre les données et les simulation Monte-Carlo est bon dans la limite de la statistique disponible. La figure \ref{cosmics_s2endcap} (b) montrent la distribution de la variable $ w_{stot} $. L'accord entre les données et les simulation Monte-Carlo est bon dans la limite de la statistique disponible.
