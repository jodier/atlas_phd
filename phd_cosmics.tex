\chapter{Validation, avec des muons cosmiques, de la simulation des gerbes électromagnétiques}
...
\begin{figure}[!ht]
  \begin{bigcenter}
    \includegraphics[height=6.1cm, keepaspectratio]{phd_lhc/muonsmer}
  \end{bigcenter}
...
\begin{figure}[!ht]
  \begin{bigcenter}
    ...
    \begin{tabular}{cc}
      \includegraphics[height=4.8cm, keepaspectratio]{phd_lhc/toy_a}
      &
      \includegraphics[height=4.8cm, keepaspectratio]{phd_lhc/toy_b}
      \\
      (a) & (b)
    \end{tabular}
...
\begin{figure}[!ht]
  \begin{bigcenter}
    ...
    \begin{tabular}{cc}
      \includegraphics[height=4.8cm, keepaspectratio]{phd_lhc/toy_c}
      &
      \includegraphics[height=4.8cm, keepaspectratio]{phd_lhc/toy_d}
      \\
      (a) & (b)
    \end{tabular}
...
Pour le tonneau, le premier compartiment du calorimètre électromagnétique dispose d'un granularité huit fois plus fine que dans le second compartiment. Dans cette section, nous réalisons une étude de variables de forme de gerbes électromagnétiques dans le premier compartiment.
