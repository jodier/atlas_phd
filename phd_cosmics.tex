...
\begin{figure}[!ht]
  ...
  \end{center}
  \caption{Distribution des paramètres d'impact $ z_0 $ et $ d_0 $ pour les évènements présélectionnés avec une énergie dans l'amas supérieure à $ 5\GeV $ (a) et (b). Distribution des paramètres d'impact $ z_0 $ et $ d_0 $ pour les évènements sélectionnés avec une énergie dans l'amas $ E>5\GeV $, avec une impulsion de la trace $ p_T>5\GeV $, avec au moins un coup dans le silicium et enfin $ d_0<220mm $ (c) et (d).}
\end{figure}
