...
\begin{table}[!ht]
  ...
  \end{center}
  \caption{Granularité et couverture du calorimètre électromagnétique du détecteur Atlas.}
\end{table}
...
\begin{figure}[!p]
  ...
  \begin{tabular}{ccc}
    \includegraphics[width=0.45\linewidth, keepaspectratio]{phd_calo/pulse1}
    &&
    \includegraphics[width=0.45\linewidth, keepaspectratio]{phd_calo/pulse2}
    \\
    (a) && (b)
  \end{tabular}
