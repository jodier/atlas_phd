...
\begin{table}[!ht]
  ...
  \end{center}
  \caption{\label{caloperf}Performances générales du détecteur Atlas où l'énergie $ E $ et l'impulsion transverse $ p_T $ sont exprimés en $ \GeV $. Ces résultats ont été validés lors des faisceaux tests.}
\end{table}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[height=7.1cm, keepaspectratio]{phd_calo/calo1}
  \end{center}
...
\begin{table}[!ht]
  ...
  \end{center}
  \caption{\label{granilarite}Granularité et couverture du calorimètre électromagnétique du détecteur Atlas.}
\end{table}
...
\begin{figure}[!p]
  ...
  \end{center}
  \caption{Schéma de l'électronique de lecture des cellules du calorimètre électromagnétique. Du bas vers le haut, électronique froide située dans le cryostat, électronique chaude situé dans le détecteur FEB (Front End Board) et électronique chaude située hors du détecteur.}
\end{figure}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[width=0.75\linewidth, keepaspectratio]{phd_calo/signalshape}
  \end{center}
  \caption{.}
\end{figure}
...
\begin{figure}[!ht]
  \begin{center}
    \includegraphics[width=0.9\linewidth, keepaspectratio]{phd_calo/feb}
  \end{center}
  \caption{.}
\end{figure}
