...
Comme la couverture en pseudo-rapidité est meilleure pour \emph{egamma}, $ |\eta|<2.47 $, que pour \emph{softe}, $ |\eta|<2 $, la suite de ce chapitre suppose la reconstruction des candidats électrons et photons à partir de l'algorithme \emph{egamma}. Pour la reconstruction du boson de Higgs, dans le dernier chapitre de cette thèse, les électrons \emph{softe} (favorable à bas $ p_T $) et \emph{egamma} (favorable à haut $ p_T $) seront utilisés.
...
\begin{figure}[!ht]
  ...
  \end{bigcenter}
  \caption{\label{isEM1}Efficacité de sélection des électrons \emph{loose}, \emph{medium} et \emph{tight} (étude \emph{Tag\&Probe} réalisée sur des électrons provenant de bosons Z) en fonction de l'énergie transverse $ E_T $ (a) et en fonction de la pseudo-rapidité $ \eta $ (b).}
\end{figure}
...
On introduit \emph{medium++} (\emph{intermédiaire++}). Sa définition est similaire à celle de \emph{medium} à laquelle on ajoute les contraintes additionnelles suivantes :
\begin{itemize}
