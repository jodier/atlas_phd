...
\begin{table}[!htb]
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|c|}
      ...
      Masse & 0 & 0 & & 0 \\
      \hline
      Portée & $ \infty $\tiny, confinée $ <10^{-15} $ m & $ \infty $ & $ <10^{-18} $ m & $ \infty $ \\
      \hline
...
\begin{table}[!htb]
  \begin{center}
    ...
    \begin{tabular}{|l|c|c|c|}
      ...
      \hline
      \hline
        \small Énergie-impulsion & $ \hspace{1.0cm}\bullet\hspace{1.0cm} $ & $ \hspace{1.0cm}\bullet\hspace{1.0cm} $ & $ \hspace{1.0cm}\bullet\hspace{1.0cm} $ \\
        \small Moment cinétique total & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
        \small Parité de charge $ \mathcal{C} $ & $ \bullet $ & $ \bullet $ & \\
        \small Parité d'espace $ \mathcal{P} $ & $ \bullet $ & $ \bullet $ & \\
        \small Renversement du temps $ \mathcal{T} $ & $ \bullet $ & $ \phantom{\bullet} $ & \\
        \small $ Q $ (charge électrique) & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
        \small $ L_e $ (nb. électronique) & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
        \small $ L_\mu $ (nb. muonique) & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
        \small $ L_\tau $ (nb. tauonique) & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
        \small $ B $ (nb. baryonique) & $ \bullet $ & $ \bullet $ & \\
        \small $ I $ (isospin fort) & $ \bullet $ & $ \phantom{\bullet} $ & \\
        \small $ I_3 $ (isospin fort) & $ \bullet $ & $ \bullet $ & \\
        \small $ S $ (étrangeté) & $ \bullet $ & $ \bullet $ & \\
        \small $ C $ (charme) & $ \bullet $ & $ \bullet $ & \\
        \small $ B $ (bottom) & $ \bullet $ & $ \bullet $ & \\
        \small $ T $ (top) & $ \bullet $ & $ \bullet $ & \\
        \small Parité-$ \mathcal{G}\equiv\mathcal{C}e^{i\pi I_2} $ & $ \bullet $ & $ \phantom{\bullet} $ & \\
        \small $ \mathcal{CPT} $ & $ \bullet $ & $ \bullet $ & $ \bullet $ \\
      \hline
    \end{tabular}
