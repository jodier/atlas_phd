...
Nous avons vu que pour assurer l'invariance de jauge d'un lagrangien dans le cadre d'une théorie quantique des champs, les bosons de jauge doivent être nécessairement de masse nulle. C'est le cas, par exemple, du photon pour l'interaction électromagnétique et des gluons pour l'interaction forte.

En 1983, après la découverte des bosons $ W^\pm $ et $ Z $ au CERN, il fut confirmé de façon indiscutable que ces trois bosons possèdent une masse importante. Actuellement, la masse mesurée du $ W^\pm $ est de $ 80.403(29)\GeV $ et la masse mesurée du $ Z $ est de $ 91.1876(21)\GeV $.

Le premier modèle expliquant l'acquisition de masse par les particules fut proposé en 1964 parallèlement par Gerry Guralnik, Carl Richard Hagen, et Tom Kibble, Robert Brout et François Englert ainsi que par Peter Higgs. Ce modèle est désormais connu sous le nom de \emph{mécanisme de Higgs}. Il est un pilier du modèle standard de la physique des particules cependant, sa principale prédiction, le \emph{boson de Higgs}, n'a toujours pas été observé.
