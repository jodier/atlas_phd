...
Observons l'équation \ref{euler_lagrange}, elle contient $ n $ équations différentielles d'ordre deux en $ q^i $ ($ i=1,\dots,n $). De telles équations s'intégrent et donnent des solutions uniques pour des conditions initiales $ q^i(t_0=0) $ et $ \dot q^i(t_0=0) $ connues.
