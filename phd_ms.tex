...
Plus récemment, les expériences DØ et CDF au Tevatron ont accumulé suffisamment de statistique afin de poser des limites en s'appuyant sur l'étude des canaux $ H\to WW $, $ H\to ZZ $, $ WH\to l\nu b\bar b $, $ WH/ZH\to qqb\bar b $, $ WH/ZH\to METb\bar b $, $ ZH\to llb\bar b $, $ H\to\gamma\gamma $, $ H\to\tau\tau $, $ H\to b\bar b $, etc... Les résultats sont représentés sur la figure \ref{higgs_exp2}. La région qui s'étend de $ 158\GeV $ jusqu'à $ 175\GeV $ est exclue à $ 95\% $ de niveau de confiance\cite{FermilabHiggs}.
