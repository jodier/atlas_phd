...
\end{equation}
\begin{equation}
  \cos\theta_W=\frac{g}{\sqrt{g^2+g'^2}}\hspace{0.33cm}\mathrm{,}\hspace{0.33cm}\sin\theta_W=\frac{g'}{\sqrt{g^2+g'^2}}
\end{equation}
