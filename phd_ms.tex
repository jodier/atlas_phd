...
\begin{equation}
  \Psi_1\equiv\binom{\nu_e}{e}_\mathrm{L}\ ;\ \binom{\nu_\mu}{\mu}_\mathrm{L}\ ;\ \ldots=\binom{u}{d}_\mathrm{L}\ ;\ \binom{s}{c}_\mathrm{L}\ ;\ \ldots\hspace{0.33cm}\mathrm{pour}\hspace{0.33cm}\binom{I^\mathrm{W}_3=+\frac{1}{2}}{I^\mathrm{W}_3=-\frac{1}{2}}
\end{equation}
...
Si l'on pose $ W^\pm_\mu=\frac{1}{\sqrt{2}}\left(W^1_\mu\mp iW^2_\mu\right) $ alors $ \sigma_1W^1_\mu+\sigma_2W^2_\mu=\sqrt{2}\left(\begin{array}{cc}0&W^-_\mu\\W^+_\mu&0\end{array}\right) $, le lagrangien peut se réécrire :
\begin{eqnarray}
...
En utilisant l'expression des projecteurs (équations \ref{projecteurs}), le lagrangien peut se réécrire sous sa forme définitive :
\begin{equation}
