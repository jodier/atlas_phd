...
Le mouvement d'une particule est identifié par son \emph{vecteur de position} (un tenseur de rang 1) noté $ \vec r $ et de coordonnées $ r^i $. La \emph{vitesse} d'une particule est définie par :
\begin{displaymath}
